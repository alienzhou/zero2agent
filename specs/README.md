...
| 层级 | 名称 | 状态 | 入口 |
|------|------|------|------|
| Epic | [E01：能看 / 能查](./E01-read-and-search/README.md) | ✅ 已完成 | 阶段导览 |
...
| Story | [E01-S004：固定 Prompt 结构](./E01-read-and-search/S004-prompt-structure/README.md) | ✅ 已完成 | Story 入口 + `details/` |
