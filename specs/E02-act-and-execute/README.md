...
| [S003：驱动执行环境](./S003-terminal/README.md) | 引入 `terminal`，让 Agent 能执行命令；**并处理超长输出 / 长命令 / 进程生命周期 / 执行环境** | ✅ 已完成 |
| [S004：交互式命令](../../.discuss/2026-09-18/e02-s004-interactive-commands/outline.md) | `stdin` 续写与 pty —— 判据是「**要不要人输入**」 | 🚧 讨论中 |
